...
def extract_mesh_from_coarse_sugar(args):
    ...
    use_centers_to_extract_mesh = args.use_centers_to_extract_mesh  # False
    use_marching_cubes = args.use_marching_cubes                    # False
    use_vanilla_3dgs = args.use_vanilla_3dgs                        # False
    ...
    if not use_marching_cubes:
        ...
        resolution = 512 # NOTE: can reduce due to OOM (default: 512)
...
def extract_mesh_and_texture_from_coarse_sugar(args):
    CONSOLE = Console(width=120)
    ...
    with torch.no_grad():
        verts_uv, faces_uv, texture_img = extract_texture_image_and_uv_from_gaussians(
            sugar, square_size=square_size, n_sh=1, texture_with_gaussian_renders=True)
    ...
    CONSOLE.print("Texture saved at:", mesh_output_dir)
